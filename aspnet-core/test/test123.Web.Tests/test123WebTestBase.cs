...
{
    public abstract class test123WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static test123WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(test123WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<test123DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<test123DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<test123DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<test123DbContext, Task<T>> func)
        {
            T result;
