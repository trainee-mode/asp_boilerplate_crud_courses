...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("test123.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("test123.Quizzes.Option", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("test123.Quizzes.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("test123.Quizzes.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("test123.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("test123.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("test123.Quizzes.Option", b =>
                {
                    b.HasOne("test123.Quizzes.Question", "Question")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("test123.Quizzes.Question", b =>
                {
                    b.HasOne("test123.Quizzes.Quiz", "Quiz")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("test123.Quizzes.Quiz", b =>
                {
                    b.HasOne("test123.Courses.Course", "Course")
                        .WithMany("Quizzes")
