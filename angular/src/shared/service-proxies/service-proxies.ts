...
export class CourseServiceProxy {
     ...
     * @return Success
     */
    createCourse(body: CreateCourseDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    getAllCourses(): Observable<GetAllCourseDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetAllCourseDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetAllCourseDto[]>;
        }));
    }

    protected processGetAllCourses(response: HttpResponseBase): Observable<GetAllCourseDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(GetAllCourseDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getCourseById(id: string | undefined): Observable<GetAllCourseDto> {
    ...
    protected processGetCourseById(response: HttpResponseBase): Observable<GetAllCourseDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetAllCourseDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    deleteCourse(id: string | undefined): Observable<void> {
     ...
     * @return Success
     */
    getCourseByTitle(title: string | undefined): Observable<GetAllCourseDto> {
        let url_ = this.baseUrl + "/api/services/app/Course/GetCourseByTitle?";
        if (title === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCourseByTitle(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCourseByTitle(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetAllCourseDto>;
                }
            } else
    ...
    protected processGetCourseByTitle(response: HttpResponseBase): Observable<GetAllCourseDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class GetAllCourseDto implements IGetAllCourseDto {
    id: string;
    title: string | undefined;
    description: string | undefined;

    constructor(data?: IGetAllCourseDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetAllCourseDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetAllCourseDto();
        result.init(data);
        return result;
    }
...
export interface IGetAllCourseDto {
    id: string;
    title: string | undefined;
    description: string | undefined;
}
